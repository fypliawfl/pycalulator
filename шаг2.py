...
if __name__ == "__main__":
    ...
    first_number_value = tkinter.StringVar()
    ...
    clear_button.place(relx=0.7, rely=0.3, relwidth=0.2, relheight=0.13)
    multiplication_button.place(relx=0.25, rely=0.65, relwidth=0.2, relheight=0.13)
    division_button.place(relx=0.55, rely=0.65, relwidth=0.2, relheight=0.13)
